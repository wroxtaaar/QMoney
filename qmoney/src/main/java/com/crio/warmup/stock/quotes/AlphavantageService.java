...
public class AlphavantageService implements StockQuotesService {
  ...
  public static final String TOKEN = "L8PI9O8PNSPP93Q6";
  ...
  protected String buildUri(String symbol) {
    return String.format("https://www.alphavantage.co/query?function=%s&symbol=%s&apikey=%s", FUNCTION, symbol, TOKEN);
  }
